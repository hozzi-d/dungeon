...
function random_ghost10 () {
    ...
    tiles.placeOnTile(ghost10, tiles.getTileLocation(25, 27))
}
function random_ghost20 () {
    ghost = sprites.create(img`
        ........................
        ........................
        ........................
...
function random_ghost9 () {
    ...
    tiles.placeOnTile(ghost9, tiles.getTileLocation(25, 27))
}
...
function random_ghost11 () {
    ...
    tiles.placeOnTile(ghost11, tiles.getTileLocation(25, 27))
}
function random_ghost4 () {
    ...
    tiles.placeOnTile(ghost4, tiles.getTileLocation(25, 27))
}
...
function random_ghost5 () {
    ...
    tiles.placeOnTile(ghost5, tiles.getTileLocation(25, 27))
}
...
function random_ghost7 () {
    ...
    tiles.placeOnTile(ghost7, tiles.getTileLocation(25, 27))
}
function random_ghost22 () {
    ghost = sprites.create(img`
        ........................
        ........................
        ........................
...
function random_ghost8 () {
    ...
    tiles.placeOnTile(ghost8, tiles.getTileLocation(25, 27))
}
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    otherSprite.destroy()
    info.changeScoreBy(1)
})
function random_ghost25 () {
    ghost = sprites.create(img`
        ........................
        ........................
        ........................
