...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile33`, function (sprite, location) {
    tiles.placeOnRandomTile(arthur, assets.tile`myTile34`)
...
game.onUpdate(function () {
    ...
    if (ghost10.overlapsWith(arthur)) {
        animation.runImageAnimation(
        ghost10,
        [img`
            ........................
    ...
    if (ghost11.overlapsWith(arthur)) {
        animation.runImageAnimation(
        ghost11,
        [img`
            ........................
    ...
    if (ghost12.overlapsWith(arthur)) {
        animation.runImageAnimation(
        ghost12,
        [img`
            ........................
    ...
    if (ghost13.overlapsWith(arthur)) {
        animation.runImageAnimation(
        ghost13,
        [img`
            ........................
    ...
    if (ghost14.overlapsWith(arthur)) {
        animation.runImageAnimation(
        ghost14,
        [img`
            ........................
    ...
    if (ghost15.overlapsWith(arthur)) {
        animation.runImageAnimation(
        ghost15,
        [img`
            ........................
